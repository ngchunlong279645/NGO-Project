...
public class Advertisement extends JFrame {
	...
	public Advertisement() { //constructor with no argument
		...
		lblBlogger.setIcon(new ImageIcon(getClass().getResource(""))); 
		...
		lblInsta.setIcon(new ImageIcon(getClass().getResource(""))); 
		...
		lblFB.setIcon(new ImageIcon(getClass().getResource(""))); 
		...
		lblLuckyDrawWheel.setIcon(new ImageIcon(getClass().getResource("")));
