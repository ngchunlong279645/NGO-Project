...
public class AdminHome extends JFrame {
	...
	public AdminHome() {
		...
		financeBtn.setIcon(new ImageIcon(AdminHome.class.getResource("")));
		...
		button_1.setIcon(new ImageIcon(AdminHome.class.getResource("")));
		...
		button_2.setIcon(new ImageIcon(AdminHome.class.getResource("")));
		...
		button_3.setIcon(new ImageIcon(AdminHome.class.getResource("")));
