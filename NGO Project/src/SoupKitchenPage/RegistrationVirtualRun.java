	...
	public RegistrationVirtualRun() {
		...
		contentPane = new JPanel(){
			public void paintComponent(Graphics g) {  // inserting background picture
				Image img = Toolkit.getDefaultToolkit().getImage(
						RegistrationVirtualRun.class.getResource(""));  
		...
		btnNewButton_1_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent O) {
				try {
					File file = new File("C:\\Users\\Farah Nabilah\\Desktop\\Hope Soup Kitchen\\Virtual Run Registration.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
		...
		btnNewButton_1_2_1_1.setBounds(10, 11, 157, 44);
