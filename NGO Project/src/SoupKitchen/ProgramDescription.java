...
public class ProgramDescription extends JFrame {
	...
	public ProgramDescription() {
		...
		BreakfastLogo.setIcon(new ImageIcon(ProgramDescription.class.getResource("ProgramDes2.PNG")));
		BreakfastLogo.setBounds(81, 431, 105, 129);
		panel.add(BreakfastLogo);
		
		JLabel LunchLogo = new JLabel("");
		LunchLogo.setIcon(new ImageIcon(ProgramDescription.class.getResource("ProgramDes3.PNG")));
		LunchLogo.setBounds(259, 416, 105, 129);
		panel.add(LunchLogo);
		
		JLabel DinnerLogo = new JLabel("");
		DinnerLogo.setIcon(new ImageIcon(ProgramDescription.class.getResource("ProgramDes4.PNG")));
		...
		btnHome.setBounds(10, 70, 116, 39);
		panel.add(btnHome);
	}
}
