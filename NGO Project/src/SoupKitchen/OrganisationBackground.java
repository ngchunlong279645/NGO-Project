...
import ChildrensWelfare.AdminPage;
...
public class OrganisationBackground extends JFrame {
	...
	public OrganisationBackground() {
		...
		OrganisationLogo.setIcon(new ImageIcon(OrganisationBackground.class.getResource("OrganisationBackground.PNG")));
		...
		btnHome.setBounds(10, 69, 126, 47);
		panel.add(btnHome);
	}
}
