...
public class Main extends JFrame {
	...
	public Main() {
		...
		button.setIcon(new ImageIcon(Main.class.getResource("youtube-icon.png")));
		...
		button_1.setIcon(new ImageIcon(Main.class.getResource("twitter-icon.png")));
		...
		button_2.setIcon(new ImageIcon(Main.class.getResource("social-media-icon.png//")));
		...
		button_3.setIcon(new ImageIcon(Main.class.getResource("facebook-icon.png//")));
		...
		label.setIcon(new ImageIcon(Main.class.getResource("10003490_684354198272969_1131493672_n.png//")));
