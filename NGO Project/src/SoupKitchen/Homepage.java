	...
	public Homepage() {
		...
		mntmNewMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Homepage frame = new Homepage();//action
				frame.setVisible(true);
				dispose();
			}
		});
		...
		JMenu mnNewMenu_6 = new JMenu("Advertisement");
		menuBar.add(mnNewMenu_6);
		
		JMenuItem mntmNewMenuItem_9 = new JMenuItem("Benefits");
		...
		contentPane = new JPanel(){
			public void paintComponent(Graphics g) {  // inserting background picture
				Image img = Toolkit.getDefaultToolkit().getImage(
						Donating.class.getResource("home.JPG"));  
